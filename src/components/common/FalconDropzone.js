...
const FalconDropzone = ({ placeholder, className, onChange, files, preview }) => (
  <Fragment>
    <Dropzone
        ...
        <div
          {...getRootProps({
            className: classNames(
              'p-5 border-dashed border-2x border-300 bg-light rounded-soft text-center cursor-pointer',
              className
            )
          })}
        >
...
FalconDropzone.defaultProps = {
  placeholder: 'Drop or Upload file(s)',
  files: [],
  preview: false
};
